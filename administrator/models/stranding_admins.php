...
/**
 * Methods supporting a list of Stranding_Admins records.
 */
class Stranding_formsModelStranding_admins extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'observation_species', 'a.observation_species',
                'observation_species_identification', 'a.observation_species_identification',
                ...
                'sampling_protocole', 'a.sampling_protocole',
		        'remarks', 'a.remarks',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_stranding_forms');
