 ...
 */
class Stranding_formsControllerStranding_admin extends Stranding_formsController {
    ...
    public function edit() {
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_stranding_forms&view=stranding_adminform&layout=edit', false));
    }
    ...
    public function validate() {
        ...
        if ($return === false) {
            ...
            $this->setMessage(JText::_('COM_STRANDING_FORMS_ITEM_VALIDATED_SUCCESSFULLY'));
        }
