...
class Stranding_formsModelStranding_admins extends JModelList {
    ...
    protected function getListQuerySimple() {
      ...
      $query->select(
        $this->getState(
          'list.select', 'CONCAT("EC",Year(observation_datetime),"-","0",a.id,"-","0",id_location+1),
