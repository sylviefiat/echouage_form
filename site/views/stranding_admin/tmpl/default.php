			...
			<div class="panel-body">
                <div class="card-columns">
                    <div class="card">
                        <div class="card-header">
                            <span class="fa fa-user fa-2x"> <?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_OBSERVER') ?></span>
                        </div>
                        <div class="card-body">
                            <div>
                    ...
                    <div class="card">
                        <div class="card-header">                    
                            <span class="fa fa-user fa-2x"> <?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_INFORMANT') ?></span>
                        </div>
                        <div class="card-body">
                            <div>
                                <label><?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_NAME'); ?></label>
                    ...
                    <div class="card">
                        <div class="card-header">                    
                            <span class="fa fa-ship fa-2x"> <?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_OBSERVATION_STRANDING_TYPE') ?></span>
                        </div>
                        <div class="card-body">
                            <div>
                ...
                <div class="row tabs">
                    ...
                    <div class="animal<?php echo $key ?>">
                        <div class="card-columns">
                            <div class="card">
                                <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_DESC_STRANDING_ADMIN_OBSERVATION_IDENTIFICATION'); ?></span></div>
                                <div class="card-body">
                                    <div>
                                    ...
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_SPECIES_COMMON_NAME_LABEL'); ?></label>
                            ...
                            <div class="card">
                                <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_DESC_STRANDING_ADMIN_OBSERVATION_ANIMAL'); ?></span></div>
                                <div class="card-body">
                                    <div>
                            ...
                            <div class="card"> 
                                <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_REMARKS'); ?></span></div>
                                <div class="card-body">                           
                                    <div>
                        ...
                        <div class="hgroups card-columns">
                            <div class="card hgroups">
                                <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_MESURES_GLOBALES'); ?></span></div>
                                <div class="card-body" style="display:flex;">
                                    <div>
                                        <!-- DAUPHINS -->
                                        <div style="display:<?php echo ($animal->observation_species_genus=='Dugong' || $animal->observation_species_genus=='Arctophoca') ? 'none' : 'flex'; ?>">
                                        ...
                                        <!-- DAUPHINS -->
                                        <div style="display:<?php echo ($animal->observation_species_genus=='Dugong' || $animal->observation_species_genus=='Arctophoca') ? 'flex' : 'none'; ?>">
                                            <img src='/administrator/components/com_stranding_forms/assets/images/dugong/large/l_dugong_body.png' alt='Mesures sur cétacés' title='<?php echo JText::_('COM_STRANDING_FORMS_EDIT_ITEM_MESURES_CETACE_IMAGE_DESC'); ?>' />
                                        </div>
                                    </div>
                                    <div class="mesures">
                        ...
                        <div class="card hgroups">
                            <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_MESURES_DETAILS'); ?></span></div>
                            <div class="card-body" style="display:flex;">
                                <div>
                                    <!-- dauphin -->                                
                                    <div style="display:<?php echo ($animal->observation_species_genus=='Dugong' || $animal->observation_species_genus=='Arctophoca') ? 'none' : 'flex'; ?>">
                                    ...
                                    <div style="display:<?php echo ($animal->observation_species_genus=='Dugong' || $animal->observation_species_genus=='Arctophoca') ? 'flex' : 'none'; ?>">
                                        <img src='/administrator/components/com_stranding_forms/assets/images/dugong/large/l_dugong_details.png' alt='Mesures sur cétacés' title='<?php echo JText::_('COM_STRANDING_FORMS_EDIT_ITEM_MESURES_CETACE_IMAGE_DESC'); ?>' />
                                    </div>
                                </div>
                                <div class="mesures">
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_N'); ?></label>
                                        <span><?php echo $animal->observation_mesure_n; ?>m</span>
                                    </div>
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_O'); ?></label>
                                        <span><?php echo $animal->observation_mesure_o; ?>m</span>
                                    </div>
                                    <div>
                                        <label class="mesure important"><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_P'); ?></label>
                                        <span><?php echo $animal->observation_mesure_p; ?>m</span>
                                    </div>
                                    <div>
                                        <label class="mesure important"><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_Q'); ?></label>
                                        <span><?php echo $animal->observation_mesure_q; ?>m</span>
                                    </div>
                                    <div>
                                        <label class="mesure important"><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_R'); ?></label>
                                        <span><?php echo $animal->observation_mesure_r; ?>m</span>
                                    </div>
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_S'); ?></label>
                                        <span><?php echo $animal->observation_mesure_s; ?>m</span>
                                    </div>
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_T'); ?></label>
                                        <span><?php echo $animal->observation_mesure_t; ?>m</span>
                                    </div>
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_U'); ?></label>
                                        <span><?php echo $animal->observation_mesure_u; ?>m</span>
                                    </div>
                                    <div>
                                        <label><?php echo JText::_('OBSERVATION_DOLPHIN_MESURES_V'); ?></label>
                                        <span><?php echo $animal->observation_mesure_v; ?>m</span>
                                    </div>
                                </div>
                            </div>
                        </div>                
                    ...
                    <div class="card"> 
                        <div class="card-header"><span class="fa fa-fingerprint fa-2x"><?php echo JText::_('COM_STRANDING_FORMS_FORM_LBL_STRANDING_ADMIN_ADMIN_VALIDATION'); ?></span></div>
                            <div class="card-body"> 
                                <div>
                                    <span><?php if(!$this->item->admin_validation){ ?><span class="fa fa-square-o"> Non validée <?php } else { ?> <span class="fa fa-check"> Validée</span><?php } ?></span></span>
                                </div>
                            </div>
                        </div>
				</div>
